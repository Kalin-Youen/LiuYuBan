...
一句话先说清：差结构学习法不是终极存在论，而是一套跨学科学习、推理与验证的方法。

它的走法也很简单：先分辨不同，再看边界、持续、反馈与耗散，最后判断什么能站住、能重复、能验证。项目当前用“落差”把不同学科里的梯度、势差、温差、压差、浓度差与耦合不均串成同一条学习线，使它既能接入大模型训练，也能转成人类学习副本。仓库同时包含：
...
1. 先看十条轻内容：`研究文稿/08_轻内容连载`
2. 再读白话卷卷首：`研究文稿/07_书稿/白话卷/00_卷首_怎么读这本白话卷.md`
3. 然后读白话卷第1章：`研究文稿/07_书稿/白话卷/第1章_世界先给人的不是物而是不同.md`
4. 最后根据兴趣进入主书稿摘要、专题、术语与 AI 协作卷
