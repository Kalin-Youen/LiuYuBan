...
这是一个围绕“先分辨不同，再看边界、持续、反馈与耗散，再判断什么能站住、能重复、能验证”展开的中文研究项目仓库。当前对外名称统一为“差结构学习法”。这套方法的强项，在于用“落差”把不同学科里的梯度、势差、温差、压差、浓度差与耦合不均串成一条可联想、可比较、可回跳的学习线，使它既能接入大模型训练，也能转成人类学习副本。它同时包含：
...
当前公开名称已统一调整为“差结构学习法”。原因很直接：此前用过的“流态存在论”“差异结构存在论”“差异结构持续论”等名字，都太像某种终极存在论命名，容易让读者误会这里是在再造一个“解释一切”的大词。现在更明确的公开定位是：**这里提供的是一套学习与推理方法。它先教人分辨不同，再看边界、持续、反馈与耗散，最后判断什么能站住、能重复、能验证；并借“落差”这一串联词，把人和 AI 都能反复调用的跨学科联想线压实。**
...
2. 再读主书稿摘要：`研究文稿/07_书稿/00_摘要与关键词.md`
3. 然后根据兴趣进入主书稿章节、专题、术语与 AI 协作卷
