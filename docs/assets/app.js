...
/**
 * 量子力学可视化 - 入口函数
 * 使用模块化架构：quantum-viz-core.js, quantum-viz-formulas.js, quantum-viz-main.js
 */
function renderLabQuantum() {
  // 检查模块是否加载
  if (typeof QuantumVizMain !== 'undefined') {
    QuantumVizMain.init(dom.labContent);
  } else {
    // 模块未加载时显示提示
    dom.labContent.innerHTML = '<div style="padding:40px;text-align:center;color:#888;">'
      + '<p>量子可视化模块加载中...</p>'
      + '<p style="font-size:12px;margin-top:10px;">如果长时间未显示，请刷新页面</p>'
      + '</div>';
  }
}

// ==================== 以下为旧版内联代码（已迁移到模块） ====================
// 新的模块化代码位于: assets/quantum-viz/
//   - quantum-viz-core.js: 核心工具函数和常量
//   - quantum-viz-formulas.js: 64个可视化函数
//   - quantum-viz-main.js: 主入口和动画循环
// ==================== 旧版代码保留作为参考 ====================

/*
function renderLabQuantum_OLD() {
